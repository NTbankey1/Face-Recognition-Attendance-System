...
<body>
    ...
    <section class="main">
        ...
        <div class="main--content">
            ...
            <button class="add" onclick="exportTableToExcel('attendaceTable', '<?php echo htmlspecialchars($unitCode . '_on_' . date('Y-m-d'), ENT_QUOTES, 'UTF-8'); ?>','<?php echo htmlspecialchars($coursename, ENT_QUOTES, 'UTF-8'); ?>', '<?php echo htmlspecialchars($unitname, ENT_QUOTES, 'UTF-8'); ?>')">Export Attendance As Excel</button>
