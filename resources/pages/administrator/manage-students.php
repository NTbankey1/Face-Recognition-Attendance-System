...
if (isset($_POST['addStudent'])) {
    ...
    $folderPath = labels_folder_for($registrationNumber) . DIRECTORY_SEPARATOR;
    ...
    if ($count > 0) {
        $_SESSION['message'] = "Sinh viên với mã số: $registrationNumber đã tồn tại!";
    } else {
    ...
    ");
        ...
        // log event for audit/export
        log_event('admin', 'add_student', [
            'registrationNumber' => $registrationNumber,
            'firstName' => $firstName,
            'lastName' => $lastName,
            'email' => $email,
        ...
        $_SESSION['message'] = "Thêm sinh viên $registrationNumber thành công!";
    }
}
                ...
                <form method="post">
                    ...
                    <div>
                        <div>
                            ...
                            <input type="text" required id="registrationNumber" name="registrationNumber" placeholder="Mã sinh viên"> <br>
                            <p id="error" style="color: red; display: none;">Đã loại bỏ ký tự không hợp lệ.</p> 
                    ...
                    <input type="submit" class="btn-submit" value="Lưu sinh viên" name="addStudent" />
    ...
    <script>
        ...
        registrationNumberInput.addEventListener('input', () => {
            ...
            if (originalValue !== sanitizedValue) {
                ...
                errorMessage.textContent = 'Đã loại bỏ ký tự không hợp lệ.';
            } else {
