...
if (isset($_POST["addCourse"])) {
    ...
    if ($courseName && $courseCode && $facultyID) {
        ...
        if ($query->rowCount() > 0) {
            $_SESSION['message'] = "Khóa học đã tồn tại";
        } else {
        ...
        $_SESSION['message'] = "Dữ liệu khóa học không hợp lệ";
    }
}
...
if (isset($_POST["addUnit"])) {
    ...
    if ($unitName && $unitCode && $courseID) {
        ...
        if ($query->rowCount() > 0) {
            $_SESSION['message'] = "Môn học đã tồn tại";
        } else {
        ...
        $_SESSION['message'] = "Dữ liệu môn học không hợp lệ";
    }
}
...
if (isset($_POST["addFaculty"])) {
    ...
    if ($facultyName && $facultyCode) {
        ...
        if ($query->rowCount() > 0) {
            $_SESSION['message'] = "Khoa đã tồn tại";
        } else {
        ...
        $_SESSION['message'] = "Dữ liệu khoa không hợp lệ";
    }
}
...
<body>
    ...
    <section class="main">
        ...
        <div class="main--content">
            ...
            <div class="overview">
                ...
                <div class="cards">
                    <div id="addCourse" class="card card-1">
                        ...
                        <div class="card--data">
                            <div class="card--content">
                                ...
                                <h1><?php total_rows('tblcourse') ?> Khóa học</h1>
                            </div>
                    ...
                    <div class="card card-1" id="addUnit">
                        ...
                        <div class="card--data">
                            <div class="card--content">
                                <button class="add"><i class="ri-add-line"></i>Thêm môn học</button>
                                <h1><?php total_rows('tblunit') ?> Môn học</h1>
                            </div>
            ...
            <div class="table-container">
                <div class="title">
                    <h2 class="section--title">Môn học</h2>
                </div>
                </a>
                <div class="table">
                    <table>
        ...
        <div class="formDiv" id="addCourseForm" style="display:none; ">
            ...
            <form method="POST" action="" name="addCourse" enctype="multipart/form-data">
                ...
                <input type="text" name="courseName" placeholder="Tên khóa học" required>
                <input type="text" name="courseCode" placeholder="Mã khóa học" required>
                ...
                <input type="submit" class="submit" value="Lưu khóa học" name="addCourse">
            </form>
        </div>
        ...
        <div class="formDiv" id="addUnitForm" style="display:none; ">
            <form method="POST" action="" name="addUnit" enctype="multipart/form-data">
                ...
                <input type="text" name="unitName" placeholder="Tên môn học" required>
                <input type="text" name="unitCode" placeholder="Mã môn" required>

                <select required name="lecture">
                    <option value="" selected>Gán giảng viên</option>
                    <?php
                ...
                <input type="submit" class="submit" value="Lưu môn học" name="addUnit">
            </form>
        </div>
